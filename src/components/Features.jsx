    ...
    <section className="bg-black pb-12">
      <div className="container mx-auto px-3 md:px-10">
        <div className="px-5 pt-32 pb-16">
          ...
          <p className="max-w-md font-circular-web text-lg text-blue-50 opacity-50 pb-5">
          ...
          <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
            ...
            <BentoTilt className="bento-title_2">
              <div className="flex size-full flex-col justify-between bg-[#dfdff0] p-5">
                <h1 className="bento-title special-font max-w-64 text-black">
                  M<b>o</b>re co<b>m</b>ing s<b>o</b>on!
                </h1>
                <TiLocationArrow className="m-5 scale-[5] self-end text-black"></TiLocationArrow>
              </div>
            </BentoTilt>

            <BentoTilt className="bento-title_2 max-md:col-span-2">
              <video
